...
controller.view = (req, res) => {
  const { PID } = req.params;
  req.getConnection((err, conn) => {
    conn.query('SELECT H.HID, H.ROOMS, H.FLOOR, H.AREA, H.TYPE, H.MAINTENANCE, H.PARKING, H.FURNISHED, H.PID FROM PROPERTY P, HOUSE H WHERE H.PID = P.PID AND P.PID = ?', [PID], (err, rows) => {
